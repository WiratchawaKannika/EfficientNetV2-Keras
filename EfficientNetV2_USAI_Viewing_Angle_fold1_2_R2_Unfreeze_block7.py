...
checkpoint_filepath = '/media/tohn/SSD/ModelEfficientV2/USAI/ViewingAngle_model/fold1_2/R2/checkpoint/'
...
Pth_model_save = '/media/tohn/SSD/ModelEfficientV2/USAI/ViewingAngle_model/fold1_2/R2/models/'  ##เปลี่ยน path 
