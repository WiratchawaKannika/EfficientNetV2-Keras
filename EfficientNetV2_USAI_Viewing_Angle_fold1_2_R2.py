...
# Setting dataset  
## train
dataframe = pd.read_csv('/home/kannika/CSV/Traindf_fold1_2_viewingAngle.csv')  #Traindf_fold1_2_viewingAngle.csv
dataframe = dataframe[dataframe['Sub_Position_New'] != 'None']
print(f'Train Data Shape [ {dataframe.shape} ]')

#validation
valframe = pd.read_csv('/home/kannika/CSV/Validationdf_fold1_2_viewingAngle.csv') #เปลี่ยนตาม fold
valframe = valframe[valframe['Sub_Position_New'] != 'None']
print(f'Validation Data Shape [ {valframe.shape} ]')
DATA_PATH =  "/media/data/Images/Image1" 
os.chdir(DATA_PATH)
...
model_dir = '/media/data/ModelEfficientV2_USAI/USAI/ViewingAngle_model/fold1_2/R1/checkpoint/'
...
## Set TensorBoard 
root_logdir = '/media/data/ModelEfficientV2_USAI/USAI/ViewingAngle_model/fold1_2/R2/Mylogs_tensor/'  ##เปลี่ยน path 
...
checkpoint_filepath = '/media/data/ModelEfficientV2_USAI/USAI/ViewingAngle_model/fold1_2/R2/checkpoint/'
...
Pth_model_save = '/media/data/ModelEfficientV2_USAI/USAI/ViewingAngle_model/fold1_2/R2/models/'  ##เปลี่ยน path 
