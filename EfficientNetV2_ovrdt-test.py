...
#validation
valframe = pd.read_csv('/media/tohn/HDD/VISION_dataset/DATA_OVRDT/CSV/azure_ovrdtDB_Alllevel_300imgs_round1_test.csv')
...
## Set TensorBoard 
root_logdir = '/media/tohn/SSD/ModelEfficientV2/mylogs_effnetV2M_5ClassOV'
...
# Save
with open("/media/tohn/SSD/ModelEfficientV2/Model_effnetV2M_5ClassOV/efficientnetV2M_5ClassOV_lite.tflite", "wb") as file:
      file.write(tflite_model)
        
model.save('/media/tohn/SSD/ModelEfficientV2/Model_effnetV2M_5ClassOV/efficientnetV2M_5ClassOV.h5') 
print(f'Save Model as [ /media/tohn/SSD/ModelEfficientV2/Model_effnetV2M_5ClassOV/efficientnetV2M_5ClassOV.h5 ]')
