...
# model_dir = f'/media/SSD/ModelEfficientV2_14p/OVRDT_Rrgression/All_round/5Class_model/{trainfold}/R1/on_epoch_end_resume2/EffnetV2mRegression_R1_5ClassOVRDT_{trainfold}.h5'
model_dir = f'/media/SSD/ModelEfficientV2_14p/OVRDT_Rrgression/All_round/5Class_model/{trainfold}/R1/checkpoint_resume2/'
...
## Set TensorBoard 
root_logdir = f'/media/SSD/ModelEfficientV2_14p/OVRDT_Rrgression/All_round/5Class_model/{trainfold}/R1/Mylogs_tensor_resume3/'
...
root_Metrics = f'/media/SSD/ModelEfficientV2_14p/OVRDT_Rrgression/All_round/5Class_model/{trainfold}/R1/on_epoch_end_resume3/'
...
checkpoint_filepath = f'/media/SSD/ModelEfficientV2_14p/OVRDT_Rrgression/All_round/5Class_model/{trainfold}/R1/checkpoint_resume3/'
...
##Save model 
Pth_model_save = f'/media/SSD/ModelEfficientV2_14p/OVRDT_Rrgression/All_round/5Class_model/{trainfold}/R1/models/'  ##เปลี่ยน path ตาม fold 
