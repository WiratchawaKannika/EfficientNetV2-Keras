...
prediction_layer = layers.Dense(14, activation='softmax',name = 'prediction_layer')(dropout_layer_1)  ##14 == Classes Viewing angle
...
## Set TensorBoard 
root_logdir = '/media/SSD/ModelEfficientV2_14p/USAI/ViewingAngle_model/fold1_2/R1/Mylogs_tensor/'  ##เปลี่ยน path 
...
checkpoint_filepath = '/media/SSD/ModelEfficientV2_14p/USAI/ViewingAngle_model/fold1_2/R1/checkpoint/'
