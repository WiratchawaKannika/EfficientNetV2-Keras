...
prediction_layer = layers.Dense(12, activation='softmax',name = 'prediction_layer')(dropout_layer_1)  ##12 == Classes Viewing angle
...
checkpoint_filepath = '/media/tohn/SSD/ModelEfficientV2/USAI/ViewingAngle_model/fold1_2/R1/checkpoint/'
...
Pth_model_save = '/media/tohn/SSD/ModelEfficientV2/USAI/ViewingAngle_model/fold1_2/R1/models/'  ##เปลี่ยน path 
