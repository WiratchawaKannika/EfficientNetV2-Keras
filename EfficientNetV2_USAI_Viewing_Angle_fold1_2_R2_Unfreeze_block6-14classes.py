...
model_dir = '/media/tohn/SSD/ModelEfficientV2/USAI/ViewingAngle_model_14p/fold1_2/R1/models/EffnetV2m_R1_ViewingAngle_fold1_2_resume.h5'
...
## Set TensorBoard 
root_logdir = '/media/tohn/SSD/ModelEfficientV2/USAI/ViewingAngle_model_14p/fold1_2/R2_block6/Mylogs_tensor/'  ##เปลี่ยน path 
...
checkpoint_filepath = '/media/tohn/SSD/ModelEfficientV2/USAI/ViewingAngle_model_14p/fold1_2/R2_block6/checkpoint/'
...
# Save
with open(f"{Pth_model_save}EffnetV2m_R2_ViewingAngle_fold1_2_block6.tflite", "wb") as file:
      file.write(tflite_model)
#save model        
model.save(f'{Pth_model_save}EffnetV2m_R2_ViewingAngle_fold1_2_block6.h5') 
print(f'Save Model as [ {Pth_model_save}EffnetV2m_R2_ViewingAngle_fold1_2_block6.h5 ]')
