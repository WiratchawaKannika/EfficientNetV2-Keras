...
## Set TensorBoard 
root_logdir = '/media/tohn/SSD/ModelEfficientV2/OVRDT/5Class_model/R2_block6/Mylogs_tensor/'  ##เปลี่ยน path 
...
checkpoint_filepath = '/media/tohn/SSD/ModelEfficientV2/OVRDT/5Class_model/R2_block6/checkpoint/'
...
# Save
modelName = 'EffnetV2m_R2_block6_5ClassOVRDT'
